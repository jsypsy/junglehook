...
코드       BUILD 15 — 소닉 파워(D-012, 계절당 1회 찬스 잎→3바퀴→게이지→250m 로켓 대시) + 캐노피 배경(D-011, 가을 낙엽·계절 태양 크기) + 사계절(D-010, 250m·oklab·벚꽃/눈·계절 태양) + 잎 앵커 +
...
2. 사계절·캐노피(BUILD 11) 실기기 확인: 250m 경계 보간, 겨울 눈 가독성, 캐노피 층 성능(맥 0.67ms/프레임).
   **소닉 파워(BUILD 15) 손맛 판정**: 찬스 잎이 눈에 띄는지, 3바퀴(≈7.5초)·게이지 난이도, 250m 대시 — `tuning.sonic`
